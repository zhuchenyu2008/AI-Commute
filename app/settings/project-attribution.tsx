...
import { credits, creditsIntro } from "./credits";
    ...
    <>
      ...
      {isCreditsOpen ? (
        <div
          ...
          aria-modal="true"
          className="fixed inset-0 z-[70] flex items-center justify-center bg-[#191c1e]/35 px-5 py-8 backdrop-blur-sm"
          role="dialog"
        >
          <div className="w-full max-w-md rounded-2xl border border-white/70 bg-white/95 p-6 shadow-2xl shadow-slate-900/20">
            ...
            >
              ...
              <div className="space-y-3">
                {credits.map((credit) => (
                  ...
                  >
                    <p className="text-xl font-semibold text-[#191c1e]">
                      {credit.name}
                    </p>
                    <p className="mt-1 text-base text-[#434655]">{credit.note}</p>
                  </div>
                ))}
              </div>
            </div>
