    ...
    <AppShell active="memories">
      <div className="mx-auto max-w-3xl space-y-6">
        <header>
          ...
          <h1 className="mt-1 text-3xl font-bold text-[#191c1e]">记忆</h1>
        </header>

        <section className="space-y-3">
          <h2 className="text-lg font-bold text-[#191c1e]">已确认</h2>
          {memories.length === 0 ? (
        ...
        <section className="space-y-3">
          <h2 className="text-lg font-bold text-[#191c1e]">待确认</h2>
